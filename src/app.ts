...
// * The optional chaining operator is useful when working with nested properties or methods that may not exist. It helps to avoid unnecessary null checks and makes the code more concise and readable.